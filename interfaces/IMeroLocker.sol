...
interface IMeroLocker {
    ...
    function updateStartBoost(uint256 startBoost_) external;

    function updateIncreasePeriod(uint256 increasePeriod_) external;

    function updateWithdrawalDelay(uint256 withdrawalDelay_) external;
