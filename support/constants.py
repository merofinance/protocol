...
class AddressProviderKeys(Enum):
    ...
    MERO_LOCKER = format_to_bytes("meroLocker", 32, output_hex=True)
    ...
    INFLATION_MANAGER_KEY = format_to_bytes("inflationManager", 32, output_hex=True)
...
class Roles(Enum):
    ...
    INFLATION_ADMIN = format_to_bytes("inflation_admin", 32, output_hex=True)
