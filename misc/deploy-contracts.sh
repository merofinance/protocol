...
brownie run --network $NETWORK_ID scripts/deploy_mero_proxy_admin.py
...
brownie run --network $NETWORK_ID scripts/deploy_apy_helper.py
...
if [ "$LIVE" = "false" ]; then
    ...
    TOKEN_NAME="Tether USD" TOKEN_SYMBOL="USDT" brownie run --network devnet scripts/deploy_dummy_token.py
fi

POOL_NAME="merodai" brownie run --network $NETWORK_ID scripts/deploy_pool.py
POOL_NAME="meroeth" brownie run --network $NETWORK_ID scripts/deploy_pool.py
POOL_NAME="merousdc" brownie run --network $NETWORK_ID scripts/deploy_pool.py
POOL_NAME="merousdt" brownie run --network $NETWORK_ID scripts/deploy_pool.py
brownie run --network $NETWORK_ID scripts/deploy_pool_migration_zap.py
...
brownie run --network $NETWORK_ID scripts/deploy_mero_token.py
brownie run --network $NETWORK_ID scripts/deploy_inflation_manager.py

LP_TOKEN="meroDAI" brownie run --network $NETWORK_ID scripts/deploy_lp_gauge.py
LP_TOKEN="meroETH" brownie run --network $NETWORK_ID scripts/deploy_lp_gauge.py
LP_TOKEN="meroUSDC" brownie run --network $NETWORK_ID scripts/deploy_lp_gauge.py
LP_TOKEN="meroUSDT" brownie run --network $NETWORK_ID scripts/deploy_lp_gauge.py

LP_TOKEN="meroDAI" brownie run --network $NETWORK_ID scripts/deploy_keeper_gauge.py
LP_TOKEN="meroETH" brownie run --network $NETWORK_ID scripts/deploy_keeper_gauge.py
LP_TOKEN="meroUSDC" brownie run --network $NETWORK_ID scripts/deploy_keeper_gauge.py
LP_TOKEN="meroUSDT" brownie run --network $NETWORK_ID scripts/deploy_keeper_gauge.py
...
if [ "$LIVE" = "true" ]; then
    ...
    STRATEGY=usdt brownie run --network $NETWORK_ID scripts/deploy_tri_hop_strategy.py
    brownie run --network $NETWORK_ID scripts/deploy_eth_cvx_strategy.py
fi

brownie run --network $NETWORK_ID scripts/deploy_governance_timelock.py
brownie run --network $NETWORK_ID scripts/set_delays.py
