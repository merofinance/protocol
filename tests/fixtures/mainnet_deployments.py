...
def mainnet_usdc_vault(mainnet_usdc_pool):
    return interface.IVault(mainnet_usdc_pool.vault())


@pytest.fixture
@pytest.mark.mainnetFork
def mainnet_usdc_strategy(mainnet_usdc_vault):
    return interface.IStrategy(mainnet_usdc_vault.strategy())
...
def mainnet_eth_vault(mainnet_eth_pool):
    return interface.IVault(mainnet_eth_pool.vault())


@pytest.fixture
@pytest.mark.mainnetFork
def mainnet_eth_strategy(mainnet_eth_vault):
    return interface.IStrategy(mainnet_eth_vault.strategy())
