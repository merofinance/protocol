...
def strategy(MeroTriHopCvx, MeroEthCvx, vault, admin, coin, alice, bob, address_provider):
...
def test_top_up_with_strategy_withdrawal(
    vault, topUpAction, coin, interface, bob, strategy, pool, decimals, alice, lpToken, admin, chain
):
